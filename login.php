...
if (isset($_POST['login'])) {
 ...
 if (count($user_data)>0) {
    ...
    $_SESSION['emailId'] = $_POST['email'];
      echo "<script> window.location.href='AdminLTE-4.0.0-beta3/AdminLTE-4.0.0-beta3/dist/pages/index.php'; </script>";
 }else{
...
<html lang="en">
  ...
  <head>
    ...
    <meta name="author" content="Bouguetaia robin" />
    <meta
      name="description"
    />
    <meta
    ...
    <link rel="stylesheet" href="AdminLTE-4.0.0-beta3/AdminLTE-4.0.0-beta3/dist/css/adminlte.css" />
